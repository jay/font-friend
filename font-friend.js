/*
 * Soma FontFriend 0.9
 * http://somadesign.ca/projects/font-friend
 * 
...
if (jQuery('#typography-select').size() == 0 ) {
	...
	jQuery("#typo-controls div").click(function() {
		if (jQuery(this).hasClass("left") ) {
			jQuery("#typography-select").css({left:30, right:"auto"});
		} 
		if (jQuery(this).hasClass("right") ) {
				jQuery("#typography-select").css({right:30, left:"auto"});
		}
		if (jQuery(this).hasClass("up") ) {
			jQuery("#typography-select").css({top:0, bottom:"auto"});
		}
		if (jQuery(this).hasClass("down") ) {
			jQuery("#typography-select").css({bottom:0, top:"auto"});
		}
	});
	...
	jQuery("#typography-select").animate({height:280, width:600},100).addClass("open");
